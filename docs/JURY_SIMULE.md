...
> d'aucune manière dans cette thèse. Leurs critiques sont rédigées *dans l'esprit de leurs
> exigences scientifiques connues* (domaines, publications, positions publiques), à des fins
> de travail interne uniquement. Aucune citation ne leur est attribuée ; aucun propos
> ne doit être présenté comme venant d'eux. Ce document est interne (dépôt privé recommandé).

**Objet :** thèse de DBA de Serge Patrick MINANG — *gouvernance augmentée des EPES gabonais,
articulation IA × IE en situation de polycrise* (plan harmonisé + liste des supports, sept. 2026).
...
## Exigences conjointes — les 10 non-négociables des prochains échanges
